...
<<<<<<< HEAD:resources/views/backup/done.blade.php
...
>>>>>>> 864a00e8faf0979ff1bf37ac72eec8b83c6a25d4:resources/views/done.blade.php
    ...
    <div class="container">
        ...
        <div class="row bg-light" style="height: 500px;">
            <div class="col-lg border-new text-center pt-3">
                <div class="row">
                    <div style="font-family: bebas neue; font-size: 50px;">
                        TERIMA KASIH TELAH MENGGUNAKAN HAK SUARA ANDA <br> {{ auth()->guard('user')->user()->nama }}
                    </div>
                </div>
                <div class="row">
                    <div class="col">
