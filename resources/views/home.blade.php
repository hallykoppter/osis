    ...
    <div class="container">
        ...
        <div class="row bg-light" style="height: 500px;">
                ...
                @foreach( $calon as $c)
                    ...
                    <img src="/img/{{ $c->foto }}" class="card-img-top pt-2 img-fluid" alt="...">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary mt-3">pilih</a>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="col-lg-3 border-new mx-auto">
                <img class='d-flex mx-auto my-4' width="100" height="100"
                    src='https://cdn-icons-png.flaticon.com/512/3135/3135715.png' alt='Profile' />
                    <div class="form-floating">
                        <input type="text" name="nama"
                            class="form-control mb-1" id="nama" value="{{ auth()->guard('user')->user()->nama }}" disabled readonly>
                        <label for="nama">Nama</label>
                    </div>
                    <div class="form-floating">
                        <input type="text" name="kelas"
                            class="form-control mb-1" id="kelas" value="{{ auth()->guard('user')->user()->kelas }}" disabled readonly>
                        <label for="kelas">Kelas</label>
                    </div>
                    <div class="form-floating">
                        <input type="text" name="NISN"
                            class="form-control mb-1" id="NISN" value="{{ auth()->guard('user')->user()->NISN }}" disabled readonly>
